...
export function SearchItem({ item, handleSearchItemClick }: Props) {
   return (
      <Link
         onClick={handleSearchItemClick}
         to={`/anime/${item.mal_id}`}
         className="flex bg-slate-800 p-3 rounded items-center
          hover:bg-slate-900 transition duration-300 ease-in-out"
      >
         <img
            ...
            alt={item.title}
         />
         <div className="flex flex-col gap-3 ml-4 cursor-pointer">
